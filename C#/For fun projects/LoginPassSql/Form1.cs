...
namespace LoginPassSql
{
    public partial class A : Form
    {
        ...
        private void btnSignIn_Click(object sender, EventArgs e)
        {
            ...
            {
                if (LogPass[textBoxLogin.Text] == textBoxPassword.Text)
                {
                    MessageBox.Show("You are our user!\nCongratulations!");
                }
                else
                {
            ...
            {
                MessageBox.Show("We don\'t have user with login like this", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}