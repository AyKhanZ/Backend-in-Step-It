...
USE BARBER;
---------------------------------- Hairdrassers --------------------------------------
CREATE TABLE Hairdrassers(
    [id] int PRIMARY KEY IDENTITY(1,1),
    [FIO] NVARCHAR(MAX) NOT NULL CHECK([FIO] NOT LIKE N''),
    [Gender] NVARCHAR(10) NOT NULL CHECK([Gender] NOT LIKE N''),
    [PhoneNumber] NVARCHAR(15) NOT NULL CHECK([PhoneNumber] NOT LIKE N''),
    [Email] NVARCHAR(30) NOT NULL CHECK([Email] NOT LIKE N''),
    [DateOfBirthday] date NOT NULL,
    [DateOfStartWork] date NOT NULL,
    [WorkPosition] NVARCHAR(20) NOT NULL CHECK([WorkPosition] NOT LIKE N''),
    [ListOfServicesWithPriceAndTime] NVARCHAR(max) NOT NULL CHECK([ListOfServicesWithPriceAndTime] NOT LIKE N''),
    [FeedBackByClient] NVARCHAR(MAX) NOT NULL CHECK([FeedBackByClient] NOT LIKE N''),
    [MarksByClient] NVARCHAR(20) NOT NULL CHECK([MarksByClient] NOT LIKE N''),
)
---------------------------------- TimeTable --------------------------------------
CREATE TABLE TimeTable(
    [id] int PRIMARY KEY IDENTITY(1,1),
    [AvailabilityByTime] date NOT NULL,
    [SignClientUp] date NOT NULL,
)
---------------------------------- Client --------------------------------------
CREATE TABLE DataOfClient(
    [id] int PRIMARY KEY IDENTITY(1,1),
    [FIO] NVARCHAR(MAX) NOT NULL CHECK([FIO] NOT LIKE N''),
    [PhoneNumber] NVARCHAR(15) NOT NULL CHECK([PhoneNumber] NOT LIKE N''),
    [Email] NVARCHAR(30) NOT NULL CHECK([Email] NOT LIKE N''),
...
----------------------------Archive of customer visits----------------------------
CREATE TABLE ArchiveOfCustomerVisits(
    [id] int PRIMARY KEY IDENTITY(1,1),
    [CLIENT] NVARCHAR(20),
    [HAIRDRESSER] NVARCHAR(20),
    [SERVICE] NVARCHAR(20),
